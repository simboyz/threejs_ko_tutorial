        ...
        for (H = w.objects.length; a < H; a++) {
            ...
            if (O instanceof THREE.Mesh) {
                ...
                for (U = ha.length; Y < U; Y++) {
                    ...
                    F = 0;
                    for (ea = Ma.length; F < ea; F++) if (Ka = Ma[F][Y]) {
                        fa = 0;
        ...
        for (g = this.faces.length; f < g; f++) {
            ...
            if (e instanceof THREE.Face3) {
                ...
                for (a = 3; a > 0; a--) if (d.indexOf(e["abcd" [a]]) != a) {
                    ...
                    e = 0;
                    for (d = this.faceVertexUvs.length; e < d; e++)(h = this.faceVertexUvs[e][f]) && h.splice(a, 1);
                    break
                }
            }
        }
...
THREE.Loader.prototype = {
    ...
    createMaterial: function(a, b) {
        ...
        if (a.vertexColors !== void 0) if (a.vertexColors == "face") l.vertexColors = THREE.FaceColors;
            ...
            (function(a) {
                if (r) {
                    var b = a + r * Uint32Array.BYTES_PER_ELEMENT * 3,
                        c = b + r * Uint32Array.BYTES_PER_ELEMENT * 3;
...
THREE.SceneLoader.prototype.createScene = function(a, b, c) {
    ...
    function e() {
        var a;
        for (m in D.objects) if (!C.objects[m]) {
            u = D.objects[m];
    ...
    for (p in D.materials) {
        t = D.materials[p];
        for (A in t.parameters) if (A == "envMap" || A == "map" || A == "lightMap") t.parameters[A] = C.textures[t.parameters[A]];
        ...
        else if (A == "vertexColors") if (t.parameters[A] == "face") t.parameters[A] = THREE.FaceColors;
        else if (t.parameters[A]) t.parameters[A] = THREE.VertexColors;
        ...
        } else K = new THREE[t.type](t.parameters);
        C.materials[p] = K
    }
    e();
    j.callbackSync(C);
...
THREE.SkinnedMesh.prototype.updateMatrixWorld = function(a) {
    ...
    for (var b = this.bones.length, c = this.bones, d = this.boneMatrices, a = 0; a < b; a++) c[a].skinMatrix.flattenToArrayOffset(d, a * 16)
};
...
THREE.DOMRenderer = function() {
    ...
    g = function(a) {
        for (var b = document.documentElement, c = 0; c < a.length; c++) if (typeof b.style[a[c]] === "string") return a[c];
        return null
...
THREE.CanvasRenderer = function(a) {
    ...
    this.render = function(a, k) {
        ...
        function t(a, d, e, g, h, l, m, n) {
            ...
            w(D, M, G, i, T, U);
            if (n instanceof THREE.MeshBasicMaterial) if (n.map) {
            ...
            else if (n instanceof THREE.MeshLambertMaterial) if ($a) if (!n.wireframe && n.shading == THREE.SmoothShading && m.vertexNormalsWorld.length == 3) {
                Q.r = Z.r = $.r = aa.r;
                Q.g = Z.g = $.g = aa.g;
                Q.b = Z.b = $.b = aa.b;
        ...
        function u(a, d, e, g, h, l, n, m, o) {
            ...
            if (m.map || m.envMap) {
                ...
                } else if (m instanceof THREE.MeshLambertMaterial) if ($a) if (!m.wireframe && m.shading == THREE.SmoothShading && n.vertexNormalsWorld.length == 4) {
                    Q.r = Z.r = $.r = ha.r = aa.r;
                    Q.g = Z.g = $.g = ha.g = aa.g;
                    Q.b = Z.b = $.b = ha.b = aa.b;
            ...
            if (!(C === void 0 || C.visible === false)) {
                ...
                if (A instanceof THREE.RenderableParticle) {
                    ...
                    if (u.intersects(t)) {
                        ...
                        else if (C instanceof THREE.MeshLambertMaterial) if (y) {
                            s.r = w.r;
                            s.g = w.g;
                            s.b = w.b;
...
THREE.WebGLRenderer = function(a) {
            ...
            if (q) {
                ...
                for (k = q.length; j < k; j++) {
                    ...
                    if (h.boundTo === void 0 || h.boundTo === "vertices") {
                        f = 0;
                        e = h.value.length;
                        if (h.size === 1) for (d = 0; d < e; d++) {
                            g = n[d][1];
                            h.array[d] = h.value[g]
                        } else if (h.size === 2) for (d = 0; d < e; d++) {
                            g = n[d][1];
                            g = h.value[g];
                            h.array[f] = g.x;
                            h.array[f + 1] = g.y;
                            f = f + 2
                        } else if (h.size === 3) if (h.type === "c") for (d = 0; d < e; d++) {
                            g = n[d][1];
                            g = h.value[g];
                            h.array[f] = g.r;
                            h.array[f + 1] = g.g;
                            ...
                            h.array[f + 2] = g.z;
                            f = f + 3
                        } else if (h.size === 4) for (d = 0; d < e; d++) {
                            g = n[d][1];
                            g = h.value[g];
                            h.array[f] = g.x;
                            h.array[f + 1] = g.y;
            ...
            if (q) {
                ...
                for (k = q.length; j < k; j++) {
                    ...
                    if (h.needsUpdate && (h.boundTo === void 0 || h.boundTo === "vertices")) {
                        e = h.value.length;
                        f = 0;
                        if (h.size === 1) for (d = 0; d < e; d++) h.array[d] = h.value[d];
                        else if (h.size === 2) for (d = 0; d < e; d++) {
                            g = h.value[d];
                            h.array[f] = g.x;
                            h.array[f + 1] = g.y;
    ...
    function n(a, b, c, d, e) {
        ...
        if (h) {
                ...
                if (Ta) {
                    for (var k, l = 0, m = 0, n = 0, p, o, q, r = Qa, s = r.directional.colors, t = r.directional.positions, u = r.point.colors, v = r.point.positions, w = r.point.distances, z = r.spot.colors, A = r.spot.positions, C = r.spot.distances, D = r.spot.directions, F = r.spot.angles, J = r.spot.exponents, K = 0, Q = 0, M = 0, O = q = 0, c = O = 0, h = b.length; c < h; c++) {
                        ...
                        if (!k.onlyShadow) {
                            ...
                            o = k.intensity;
                            q = k.distance;
                            if (k instanceof THREE.AmbientLight) if (G.gammaInput) {
                                l = l + p.r * p.r;
                                m = m + p.g * p.g;
                                n = n + p.b * p.b
                            } else {
            ...
            b = d.uniformsList;
            j = 0;
            for (c = b.length; j < c; j++) if (l = f.uniforms[b[j][1]]) {
                h = b[j][0];
                m = h.type;
                k = h.value;
                switch (m) {
                ...
                case "t":
                    ...
                    if (l.image instanceof Array && l.image.length === 6) {
                        h = l;
                        if (h.image.length === 6) if (h.needsUpdate) {
                ...
                case "tv":
                    if (!h._array) {
                        h._array = [];
                        m = 0;
                        for (n = h.texture.length; m < n; m++) h._array[m] = k + m
                    }
    ...
    var a = a || {},
        ...
        K = a.stencil !== void 0 ? a.stencil : true,
    ...
    this.render = function(a, b, c, d) {
        ...
        for (e = m.length; d < e; d++) {
            ...
            if (k.visible && (!(k instanceof THREE.Mesh || k instanceof THREE.ParticleSystem) || !k.frustumCulled || Wa.contains(k))) {
                ...
                f.render = true;
                if (this.sortObjects) if (k.renderDepth) f.z = k.renderDepth;
                else {
    ...
    this.initWebGLObjects = function(a) {
        ...
        for (; a.__objectsAdded.length;) {
                    ...
                    if (l instanceof THREE.Geometry) {
                        ...
                        for (j in l.geometryGroups) {
                            ...
                            if (!n.__webglVertexBuffer) {
                                ...
                                if (T) {
                                    if (O.faceUvs.length > 0 || O.faceVertexUvs.length > 0) Q.__uvArray = new Float32Array(P * 2);
            ...
            if (!g.__webglActive) {
                if (g instanceof THREE.Mesh) {
                    ...
                    else for (j in l.geometryGroups) {
                        n = l.geometryGroups[j];
        ...
        for (var ib = 0, Lb = a.__webglObjects.length; ib < Lb; ib++) {
            var jb = a.__webglObjects[ib].object,
                ...
                ic = void 0,
                Ua = void 0;
            if (jb instanceof THREE.Mesh) if (ga instanceof THREE.BufferGeometry) {
                        ...
                        if (ca.__inittedArrays) {
                            ...
                            if (rd && cd) {
                                ...
                                for (S = ka.length; I < S; I++) {
                                    ...
                                    jc = N.vertexNormals;
                                    Ob = N.normal;
                                    if (jc.length === 3 && Ec) for (ja = 0; ja < 3; ja++) {
                                        Vb = jc[ja];
                                        db[Ja] = Vb.x;
                                        db[Ja + 1] = Vb.y;
                                        db[Ja + 2] = Vb.z;
                                        Ja = Ja + 3
                                    } else for (ja = 0; ja < 3; ja++) {
                                        db[Ja] = Ob.x;
                                        db[Ja + 1] = Ob.y;
                                        db[Ja + 2] = Ob.z;
                                        Ja = Ja + 3
                                ...
                                for (S = la.length; I < S; I++) {
                                    ...
                                    jc = N.vertexNormals;
                                    Ob = N.normal;
                                    if (jc.length === 4 && Ec) for (ja = 0; ja < 4; ja++) {
                                        Vb = jc[ja];
                                        db[Ja] = Vb.x;
                                        db[Ja + 1] = Vb.y;
                                        db[Ja + 2] = Vb.z;
                                        Ja = Ja + 3
                                    } else for (ja = 0; ja < 4; ja++) {
                                        db[Ja] = Ob.x;
                                        db[Ja + 1] = Ob.y;
                                        db[Ja + 2] = Ob.z;
                                        Ja = Ja + 3
                            ...
                            if (Wc) {
                                ...
                                for (ed = Wc.length; ja < ed; ja++) {
                                    ...
                                    if (x.__original.needsUpdate) {
                                        B = 0;
                                        if (x.size === 1) if (x.boundTo === void 0 || x.boundTo === "vertices") {
                                            I = 0;
                                            for (S = ka.length; I < S; I++) {
                                                N = za[ka[I]];
                                        ...
                                        } else if (x.size === 2) if (x.boundTo === void 0 || x.boundTo === "vertices") {
                                            I = 0;
                                            for (S = ka.length; I < S; I++) {
                                                N = za[ka[I]];
                                                V = x.value[N.a];
                    ...
                    if ($c) {
                        ...
                        for (md = $c.length; Rc < md; Rc++) {
                            ...
                            if (pa.needsUpdate && (pa.boundTo === void 0 || pa.boundTo === "vertices")) {
                                va = 0;
                                oc = pa.value.length;
                                if (pa.size === 1) for (Ia = 0; Ia < oc; Ia++) pa.array[Ia] = pa.value[Ia];
                                else if (pa.size === 2) for (Ia = 0; Ia < oc; Ia++) {
                                    Va = pa.value[Ia];
                                    pa.array[va] = Va.x;
                                    pa.array[va + 1] = Va.y;
                                    va = va + 2
                                } else if (pa.size === 3) if (pa.type === "c") for (Ia = 0; Ia < oc; Ia++) {
                                    Va = pa.value[Ia];
                                    pa.array[va] = Va.r;
                                    pa.array[va + 1] = Va.g;
                                    pa.array[va + 2] = Va.b;
                                    va = va + 3
                                } else for (Ia = 0; Ia < oc; Ia++) {
                                    Va = pa.value[Ia];
                                    pa.array[va] = Va.x;
                                    pa.array[va + 1] = Va.y;
                                    pa.array[va + 2] = Va.z;
                                    va = va + 3
                                } else if (pa.size === 4) for (Ia = 0; Ia < oc; Ia++) {
                                    Va = pa.value[Ia];
                                    pa.array[va] = Va.x;
                                    pa.array[va + 1] = Va.y;
                                    pa.array[va + 2] = Va.z;
    ...
    this.initMaterial = function(a, b, c, d) {
        ...
        a: {
            ...
            g = d.join();
            r = 0;
            for (d = T.length; r < d; r++) if (T[r].code === g) {
                q = T[r].program;
                break a
            }
            r = i.createProgram();
        ...
        if (a.attributes) for (f in a.attributes) q[f] !== void 0 && q[f] >= 0 && i.enableVertexAttribArray(q[f]);
        if (a.morphTargets) {
    ...
    triangulateQuads: function(a) {
        ...
        for (c = a.faces.length; b < c; b++) {
            ...
            if (d instanceof THREE.Face4) {
                ...
                d = 0;
                for (e = a.faceVertexUvs.length; d < e; d++) h[d].push(a.faceVertexUvs[d])
            }
        }
        a.faces = f;
        a.faceUvs = g;
        ...
        for (d = a.faces.length; c < d; c++) {
            ...
            if (e instanceof THREE.Face3) {
                ...
                if (o > b || q > b || m > b) {
                    ...
                    a.vertices.push(l);
                    f = 0;
                    for (g = a.faceVertexUvs.length; f < g; f++) if (a.faceVertexUvs[f].length) {
...
THREE.ImageUtils = {
    ...
    getNormalMap: function(a, b) {
        ...
        g.drawImage(a, 0, 0);
        for (var h = g.getImageData(0, 0, d, e).data, j = g.createImageData(d, e), l = j.data, k = 0; k < d; k++) for (var p = 0; p < e; p++) {
            var m = p - 1 < 0 ? 0 : p - 1,
                o = p + 1 > e - 1 ? e - 1 : p + 1,
                q = k - 1 < 0 ? 0 : k - 1,
                n = k + 1 > d - 1 ? d - 1 : k + 1,
                ...
                if (a.initialized !== true) {
                    for (var c = 0; c < a.hierarchy.length; c++) {
                        for (var d = 0; d < a.hierarchy[c].keys.length; d++) {
                            if (a.hierarchy[c].keys[d].time < 0) a.hierarchy[c].keys[d].time = 0;
                        ...
                        if (a.hierarchy[c].keys.length && a.hierarchy[c].keys[0].morphTargets !== void 0) {
                            h = {};
                            for (d = 0; d < a.hierarchy[c].keys.length; d++) for (var j = 0; j < a.hierarchy[c].keys[d].morphTargets.length; j++) {
                            ...
                            for (d = 0; d < a.hierarchy[c].keys.length; d++) {
                                var k = {};
                                for (l in h) {
                                    for (j = 0; j < a.hierarchy[c].keys[d].morphTargets.length; j++) if (a.hierarchy[c].keys[d].morphTargets[j] === l) {
                        ...
                        for (d = 1; d < a.hierarchy[c].keys.length; d++) if (a.hierarchy[c].keys[d].time === a.hierarchy[c].keys[d - 1].time) {
...
THREE.Animation.prototype.stop = function() {
    ...
    for (var a = 0; a < this.hierarchy.length; a++) if (this.hierarchy[a].animationCache !== void 0) {
...
THREE.Animation.prototype.update = function(a) {
    if (this.isPlaying) {
        ...
        for (var o = 0, q = this.hierarchy.length; o < q; o++) {
            a = this.hierarchy[o];
            j = a.animationCache;
            if (this.JITCompile && k[o][l] !== void 0) if (a instanceof THREE.Bone) {
                a.skinMatrix = k[o][l];
                a.matrixAutoUpdate = false;
...
THREE.Animation.prototype.getNextKeyWith = function(a, b, c) {
    for (var d = this.data.hierarchy[b].keys, c = this.interpolationType === THREE.AnimationHandler.CATMULLROM || this.interpolationType === THREE.AnimationHandler.CATMULLROM_FORWARD ? c < d.length - 1 ? c : d.length - 1 : c % d.length; c < d.length; c++) if (d[c][a] !== void 0) return d[c];
    return this.data.hierarchy[b].keys[0]
};
THREE.Animation.prototype.getPrevKeyWith = function(a, b, c) {
    for (var d = this.data.hierarchy[b].keys, c = this.interpolationType === THREE.AnimationHandler.CATMULLROM || this.interpolationType === THREE.AnimationHandler.CATMULLROM_FORWARD ? c > 0 ? c : 0 : c >= 0 ? c : c + d.length; c >= 0; c--) if (d[c][a] !== void 0) return d[c];
    ...
    if (this.isPlaying) {
        ...
        if ((j = g < h) && !this.loop) {
            ...
            for (l = this.hierarchy.length; a < l; a++) {
                ...
                var k = b.keys,
                    p = b.animationCache;
                if (this.JITCompile && f[a][e] !== void 0) if (d instanceof THREE.Bone) {
                    d.skinMatrix = f[a][e];
                    ...
                    if (b && c) {
                        if (c.time <= h) {
                            ...
                            } else if (!j) for (var m = k.length - 1; c.time < g && c.index !== m;) {
                                b = c;
                                c = k[b.index + 1]
                            }
                            p.prevKey = b;
...
THREE.KeyFrameAnimation.prototype.getNextKeyWith = function(a, b, c) {
    ...
    for (c = c % b.length; c < b.length; c++) if (b[c].hasTarget(a)) return b[c];
    return b[0]
};
THREE.KeyFrameAnimation.prototype.getPrevKeyWith = function(a, b, c) {
    b = this.data.hierarchy[b].keys;
    for (c = c >= 0 ? c : c + b.length; c >= 0; c--) if (b[c].hasTarget(a)) return b[c];
    return b[b.length - 1]
};
...
THREE.CubeGeometry = function(a, b, c, d, e, f, g, h) {
    ...
    if (h != void 0) for (var y in h) this.sides[y] !== void 0 && (this.sides[y] = h[y]);
...
THREE.LatheGeometry = function(a, b, c) {
    ...
    for (var g = b + 1, c = 0; c < g; c++) for (f = 0; f < d.length; f++) {
...
THREE.PlaneGeometry = function(a, b, c, d) {
    THREE.Geometry.call(this);
    for (var e = a / 2, f = b / 2, c = c || 1, d = d || 1, g = c + 1, h = d + 1, j = a / c, l = b / d, k = new THREE.Vector3(0, 1, 0), a = 0; a < h; a++) for (b = 0; b < g; b++) this.vertices.push(new THREE.Vector3(b * j - e, 0, a * l - f));
...
THREE.TubeGeometry = function(a, b, c, d, e, f) {
    ...
    for (b = 0; b < this.segments; b++) for (d = 0; d < this.segmentsRadius; d++) {
...
THREE.SubdivisionModifier.prototype.smooth = function(a) {
    ...
    z = new THREE.Vector3;
    s = 0;
    for (w = o.length; s < w; s++) if (R[s] !== void 0) {
        r.set(0, 0, 0);
        z.set(0, 0, 0);
...
THREE.ShadowMapPlugin = function() {
    ...
    this.update = function(j, l) {
        ...
        for (p = j.__lights.length; k < p; k++) {
            m = j.__lights[k];
            if (m.castShadow) if (m instanceof THREE.DirectionalLight && m.shadowCascade) for (q = 0; q < m.shadowCascadeCount; q++) {
                var s;
    ...
    this.render = function(d, e, o, q) {
        ...
        if (n) {
            ...
            for (var w, H = [], r = 0; r < n; r++) {
                w = d[r];
                if (w.visible && w.opacity !== 0) if (w.useScreenCoordinates) w.z = -w.position.z;
                else {
